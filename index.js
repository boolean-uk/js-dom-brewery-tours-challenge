...
function createBreweryList() {
  ...
  state.breweryList.forEach((brewery) => {
    ...
    p1.innerText = `${brewery.address_2}`;
    h3.appendChild(p1);
    const p2 = document.createElement("p");
    p2.innerText = `${brewery.address_3}`;
...
// add an event listener for filtering by brewery type
// browser should display correct brewery type when select from dropdown list
